...
class CodewarsRepositoryImpl(
    ...
    override fun getCompletedChallenges(userId: String, page: Int): Single<ChallengeBO> {
        return api.completedChallenges(userId, page).map { it.toBO() }
    }

    override fun getAuthoredChallenges(userId: String, page: Int): Single<ChallengeBO> {
